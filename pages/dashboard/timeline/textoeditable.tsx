...
const Textoeditable = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            let apiUrl = 'http://localhost:3001/pgtimelinevs';
            let method = 'POST';
            if (selectedId) {
                apiUrl += `/${selectedId}`;
                method = 'PUT';
            ...
            if (response.ok) {
                ...
                fetch('http://localhost:3001/pgtimelinevs')
    ...
    const handleDeleteClick = (id) => {
        fetch(`http://localhost:3001/pgtimelinevs/${id}`, {
            method: 'DELETE',
        })
            .then(response => {
                if (response.ok) {
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        ...
                                        <Row className="mb-3">
                                            <div className="col-md-12 col-12 text-end">
                                                <Button className='btn btn-primary m-1' type='submit'>Guardar</Button>
