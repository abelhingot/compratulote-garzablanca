...
import VScrudinfo from './informacionvs/crudinfo';
import VSinformacion from './informacionvs/informacionvs';
        ...
        <>
            <DefaultDashboardLayout>
                        ...
                        <div className="bg-white rounded-bottom smooth-shadow-sm ">
                            <div className="d-flex align-items-center justify-content-between pt-4 pb-2 px-4">
                                <div className="d-flex align-items-center">
                                    <div className="lh-1">
                                        <h3 className="mb-2 text-secondary">VILLA SIPAN: PÁGINA DE INFORMACIÓN</h3>
                ...
                <Row className="mb-8 m-1">
                    ...
                    {seccionActiva === 'paginas' && <VScrudinfo />}
                </Row>
