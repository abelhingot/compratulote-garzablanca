            ...
            <div className='container paginaservicios'>
                ...
                <div className='row'>
                    <div className="col-md-5 col-sm-6 col-xs-12">
                        ...
                        <Image className='img-fluid' src="/images/servicios/anuncie/imagen.png" alt=''/>
                    </div>
                    <div className="col-md-7 col-sm-6 col-xs-12 listabeneficiosredes">
                        <div className="row">
                            <div className="col-md-6"><Image src="/images/servicios/anuncie/1.png" alt="" /></div>
                            <div className="col-md-6"><Image src="/images/servicios/anuncie/2.png" alt="" /></div>
                            <div className="col-md-6"><Image src="/images/servicios/anuncie/3.png" alt="" /></div>
                            <div className="col-md-6"><Image src="/images/servicios/anuncie/4.png" alt="" /></div>
                        </div>
