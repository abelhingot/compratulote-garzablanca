...
export default function CTop() {
   ...
   return (
      <>
         <ul className="nav flex-column flex-sm-row bgProyect2 justify-content-between fw-bold" style={{ paddingRight: '40px', paddingLeft: '50px' }}>
            ...
            <span className="nav justify-content-end">
               <li className="nav-item custom-redsocial" style={{marginRight:'-12px'}}>
               ...
               <li className="nav-item custom-redsocial" style={{marginRight:'-14px'}}>
               ...
               <li className="nav-item custom-redsocial">
